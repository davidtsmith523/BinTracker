...
// const arrow = require('../assets/icons/menu.svg') as string;
// const howTo = require('../assets/icons/search.svg') as string;
// const inventory = require('../assets/icons/filter.svg') as string;
// const login = require('../assets/icons/left.svg') as string;
// const lookAt = require('../assets/icons/heart-ol.svg') as string;
// const qrCode = require('../assets/icons/share.svg') as string;
// const trashcan = require('../assets/icons/chevron-left.svg') as string;
